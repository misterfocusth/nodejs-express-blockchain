...
class FocusCoin {
    ...
    createNewChain = (req, res) => {
        ...
        res.status(200).json({ message: "Chain has been created !", data: GlobalChain })
    }
